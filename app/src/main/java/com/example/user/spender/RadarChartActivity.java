...
import com.example.user.spender.RadarMarkView;
...
//         to use for it
        MarkerView mv = new RadarMarkView(this, R.layout.radar_markview);
...
//        xAxis.setTypeface(tfLight);
        ...
        xAxis.setYOffset(0f);
        xAxis.setXOffset(0f);
        String[] mActivities = new String[]{"Burger", "Steak", "Salad", "Pasta", "Pizza"};
        xAxis.setValueFormatter(new IndexAxisValueFormatter(mActivities));
